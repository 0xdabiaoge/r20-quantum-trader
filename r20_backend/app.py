...
app = FastAPI(title="R20 Quantum Trader Standalone Backend", version="7.1.0", lifespan=lifespan, docs_url="/api/docs", redoc_url="/api/redoc")
...
def runtime_overview() -> dict[str, Any]:
    ...
    return {
        "service": {"version": "7.1.0", "pid": os.getpid(), "uptime_seconds": int(time.time() - STARTED_AT)},
...
def admin_about(x_r20_admin_token: str | None = Header(default=None)) -> dict[str, Any]:
    ...
    store = GatewayStore(GATEWAY_DB_PATH)
    return {
        "product": {"name": "R20 Quantum Trader", "version": "7.1.0", "control_plane": "R20 Gateway Runtime", "gateway_version": GATEWAY_VERSION},
        ...
        "components": [
            {"name": "FastAPI Control Plane", "version": "7.1.0"},
