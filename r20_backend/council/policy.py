...
DEFAULT_PRESET_TEMPLATES: Dict[str, Dict[str, Any]] = {
    "trader_trend": {
        ...
        "prompt": (
            ...
            "- 持仓三阶棘轮视角：波段未破位坚决 HOLD；浮盈 ≥ 0.8R 或 ROI ≥ +1.5% 主张 UPDATE_SL 将止损移至保本位（开仓成本 +0.20%），≥ 1.5R 或 ROI ≥ +3.0% 主张上移锁利（保底锁定 35%~50% 利润）；4H/1H 结构破位或极值回撤超 35% 主张 CLOSE_MARKET；止损出局标的在冷静期内严禁再提；\n"
