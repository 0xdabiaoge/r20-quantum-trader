...
| 检查 | 结果 |
|---|---|
| 后端全量 `unittest discover -s tests -t .` | **3109 OK**（skipped=1） |
| 离线套件 `tests/offline_suite.py` | **3090 OK**（skipped=27）；`CONFIG_WRITE_ATTEMPTS: []`；EGRESS 自检通过 |
