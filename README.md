...
[在线只读终端](https://www.r20.cn/) · [v6.2.0 Release](https://github.com/555cute/r20-quantum-trader/releases/tag/v6.2.0) · [LINUX DO 社区](https://linux.do/) · [独立部署](STANDALONE.md) · [恢复指南](RECOVERY_GUIDE.md)
...
- 🔄 **主页悬浮快速刷新按钮**：
  右下角常驻带旋转动效的悬浮刷新胶囊，支持一键触发全链路数据强制同步。
