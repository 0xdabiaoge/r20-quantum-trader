...
[![Version](https://img.shields.io/badge/Version-v5.4.0-6366F1.svg)](https://github.com/555cute/r20-quantum-trader/releases)
...
## 🌟 核心交易系统特性 (v5.4.0 重大升级)

### 📐 1. 三大底层数理基石 (微积分动力学 · 定积分做功 · 概率论与随机过程)
...
### 🚀 3. 顺势浮盈金字塔加仓体系 (Pyramiding + 数理双重门禁)
...
- **数理矩阵全景透视**: Tab 2 实盘推演矩阵实机点亮微积分、定积分与概率论透视卡片；
