  ...
  <div class="space-y-4">
    ...
    <template v-else-if="config">
      ...
      <div class="bg-[#0D121B] border border-[#1A2232] rounded-xl p-4">
        ...
        <div class="flex space-x-2 mt-3"><button @click="diagnose('telegram')" class="px-3 py-1.5 rounded-lg bg-[#111c2a] border border-[#33445b] text-xs font-mono text-[#b8c4d4] cursor-pointer hover:bg-[#1d3050]">仅诊断</button></div>
